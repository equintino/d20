...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Ago-2017 às 00:07
...
(20, 'Recarregar Mana 2', 'Nível 5; Recarregar Mana 1', 'Ação', 0, '0', 'Você deve sacrificar 10 pontos de vida para recuperar 30 pontos de mana.', '', 0),
...
(25, 'Teleporte 2', 'Nível 5; Teleporte 1; Esta magia deve ser feita com uma orbe.', 'Ação', 35, '14', 'Você pode se teleportar para qualquer lugar visível. Você pode levar alguém com você apenas encostando nela, mas some +2 na dificuldade da magia para cada pessoa a mais.', '', 0),
