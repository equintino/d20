...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Jun-2017 às 16:43
...
--
-- Estrutura da tabela `tb_ranger`
--

CREATE TABLE `tb_ranger` (
  `id` int(2) NOT NULL,
...
--
-- Extraindo dados da tabela `tb_ranger`
--

INSERT INTO `tb_ranger` (`id`, `habilidade`, `REQUISITOS`, `TIPO`, `MANA`, `DESCRICAO`, `excluido`) VALUES
...
--
-- Indexes for table `tb_ranger`
--
ALTER TABLE `tb_ranger`
  ADD PRIMARY KEY (`id`);
