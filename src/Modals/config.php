    ...
    <form id="form-config" class="form-horizontal" action="#" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-input" type="text" name="address"
                value="<?= (!empty($config) ? $config->address() : null) ?>" autocomplete="off" required/>
        </div>
        <div class="form-group">
            <label class="label" for="db">Nome do Banco: </label>
            <input class="form-input" type="text" name="db"
                value="<?= (!empty($config) ? $config->database() : null) ?>" autocomplete="off" required/>
        </div>
        <div class="form-group">
            <label class="label" for="user">Usuário do Banco: </label>
            <input class="form-input" type="text" name="user"
                value="<?= (!empty($config) ? $config->user() : null) ?>" autocomplete="off" required/>
        </div>
        ...
        <button class='button-style mt-3' style='margin-top: 10px' value="save">Salvar</button>
        <?php endif ?>
    </form>
</div>
