        ...
        <fieldset class="fieldset">
            ...
            <div class="row mr-4" >
                ...
                <div class="col-md">
                    ...
                    <label class="label-rpg">SIM </label><input class="form-radio" type="radio" name="active" value=1 <?= (isset($user) && $user->active == 1 ? "checked" : null) ?> />
                    <label class="label-rpg"> NÃO </label><input type="radio" name="active" value=0 <?= (isset($user) && $user->active == "0" ? "checked" : null) ?> />
                </div><!-- col -->
            </div>
        </fieldset>
        <button type="submit" class="button save" style="float: right; margin-right: 40px"><?= (isset($user) ? "Gravar Alteração" : "Salvar") ?></button>
        <?php if(!isset($user)): ?>
