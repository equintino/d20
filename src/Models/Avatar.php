...
use Core\Model;
use Database\Migrations\CreateAvatarsTable;

class Avatar extends Model implements Models
{
    ...
    {
        $sql = (new CreateAvatarsTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateAvatarsTable())->down(self::$entity);
