...
use Core\Model;
use Database\Migrations\CreateBreedsTable;

class Breed extends Model implements Models
{
    public static $entity = "breeds";
    ...
    private function update_()
    {
        ...
        $this->message = "<span class='success'>Saved sucessfully</span>";
        return $this->id;
    }
    ...
    {
        $sql = (new CreateBreedsTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateBreedsTable())->down(self::$entity);
