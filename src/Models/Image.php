...
use Core\Model;
use Database\Migrations\CreateImagesTable;

class Image extends Model implements Models
{
    ...
    {
        $sql = (new CreateImagesTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateImagesTable())->down(self::$entity);
