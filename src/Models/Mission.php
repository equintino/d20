...
use Core\Model;
use Database\Migrations\CreateMissionsTable;

class Mission extends Model implements Models
{
    protected static $entity = "missions";
    ...
    public function destroy()
    {
        ...
        $this->message = "<span class='success'>Mission was successfully removed</span>";
        $this->data = null;
    ...
    {
        $sql = (new CreateMissionsTable())->up(self::$entity);
        return $this->createTable($sql);
    }

    public function dropThisTable()
    {
        $sql = (new CreateMissionsTable())->down(self::$entity);
