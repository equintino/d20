...
class Mission extends Controller
{
    ...
    private \Models\Mission $_mission;

    public function __construct()
    {
        parent::__construct();
        $this->_mission = new \Models\Mission();
    }
    ...
    public function load(array $data): ?string
    {
        ...
        $mission = $this->_mission->load($name);
        $dataMission = [
            "id" => $mission->id,
            "name" => $mission->name,
            "place" => $mission->place,
    ...
    {
        $mission = $this->_mission->load($data['mission']);
    ...
    public function list(): void
    {
        ...
        $missions = ($this->_mission->activeAll() ?? []);
    ...
    {
        $mission = $this->_mission->load($data["id"]);
